...
particleGun->GetCurrentSource()->GetEneDist()->SetMonoEnergy(30.0 * GeV);
  ...
  particleGun->GetCurrentSource()->GetAngDist()->SetParticleMomentumDirection(v);

  //G4cout<<"***************** teta: "<< teta << " phi: " << phi << G4endl;
  //  G4cout<<"***************** v: "<< v << G4endl;
  //  G4cout<<"********* norma (v): "<< std::sqrt(Xdir*Xdir+Ydir*Ydir+Zdir*Zdir) << G4endl;

  particleGun->GetCurrentSource()->GetAngDist()->SetParticleMomentumDirection(G4ThreeVector(0, -1, 0));
  ...
  G4ThreeVector cosdir = particleGun->GetCurrentSource()->GetAngDist()->GetParticleMomentumDirection();
tetadeg = std::acos(cosdir[2])/CLHEP::pi*180.0;
phideg = std::atan2(cosdir[1], cosdir[0])/CLHEP::pi*180.0;
